        ...
        public:
            ...
            inline bool isGenerateProposal(const char* layerName){
                if (strcmp(layerName,"rpn_roi_probs_fpn2") == 0 || strcmp(layerName,"rpn_roi_probs_fpn3") == 0 ||
                    strcmp(layerName,"rpn_roi_probs_fpn4") == 0 || strcmp(layerName,"rpn_roi_probs_fpn5") == 0 ||
            ...
            virtual nvinfer1::IPlugin* createPlugin(const char* layerName, const nvinfer1::Weights* weights, int nbWeights) override{
                ...
                if (isGenerateProposal(layerName)){ // used multiple times
                    assert(nbWeights == 0 && weights == nullptr);
                ...
                else if (isRoIAlign(layerName)){ // used multiple times
                    assert(nbWeights == 0 && weights == nullptr);
